...
6. The server emits cumulative provisional predictions after enough speech and approximately every additional second. The UI replaces the cards in place and labels them provisional.
